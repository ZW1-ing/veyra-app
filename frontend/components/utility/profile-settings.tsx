            ...
            <TabsContent className="mt-4 space-y-4" value="keys">
              <div className="mt-5 space-y-2">
                ...
                {useAzureOpenai ? (
                  <>
                    {envKeyMap["azure"] ? (
                      <Label>管理员已设置 Azure OpenAI API Key。</Label>
                    ) : (
                      <Input
                  ...
                  <>
                    {envKeyMap["openai"] ? (
                      <Label>管理员已设置 OpenAI API Key。</Label>
                    ) : (
                      <Input
...

                    {
                      <div className="space-y-1">
                        {envKeyMap["azure_gpt_35_turbo_name"] ? (
                          ...
                          <>
                            <Label>Azure GPT-3.5 Turbo 部署名称</Label>

                            <Input
                              placeholder="Azure GPT-3.5 Turbo 部署名称"
...

                    {
                      <div className="space-y-1">
                        {envKeyMap["azure_gpt_45_turbo_name"] ? (
                          ...
                          <>
                            <Label>Azure GPT-4.5 Turbo 部署名称</Label>

                            <Input
                              placeholder="Azure GPT-4.5 Turbo 部署名称"
...

                    {
                      <div className="space-y-1">
                        {envKeyMap["azure_gpt_45_vision_name"] ? (
                          ...
                          <>
                            <Label>Azure GPT-4.5 Vision 部署名称</Label>

                            <Input
                              placeholder="Azure GPT-4.5 Vision 部署名称"
...

                    {
                      <div className="space-y-1">
                        {envKeyMap["azure_embeddings_name"] ? (
                          ...
                          <>
                            <Label>Azure 向量模型部署名称</Label>

                            <Input
                              placeholder="Azure 向量模型部署名称"
              ...
              <div className="space-y-1">
                {envKeyMap["anthropic"] ? (
                  <Label>管理员已设置 Anthropic API Key。</Label>
                ) : (
                  <>
              ...
              <div className="space-y-1">
                {envKeyMap["google"] ? (
                  <Label>管理员已设置 Google Gemini API Key。</Label>
                ) : (
                  <>
              ...
              <div className="space-y-1">
                {envKeyMap["mistral"] ? (
                  <Label>管理员已设置 Mistral API Key。</Label>
                ) : (
                  <>
              ...
              <div className="space-y-1">
                {envKeyMap["groq"] ? (
                  <Label>管理员已设置 Groq API Key。</Label>
                ) : (
                  <>
              ...
              <div className="space-y-1">
                {envKeyMap["perplexity"] ? (
                  <Label>管理员已设置 Perplexity API Key。</Label>
                ) : (
                  <>
              ...
              <div className="space-y-1">
                {envKeyMap["openrouter"] ? (
                  <Label>管理员已设置 OpenRouter API Key。</Label>
                ) : (
                  <>
        ...
        <div className="mt-6 flex items-center">
          <div className="flex items-center space-x-1">
            ...
            <WithTooltip
              display={
                <div>
                  下载 Chatbot UI 1.0 数据为 JSON。导入功能即将推出！
                </div>
              }
              trigger={
                <IconFileDownload
